...
<div class="card col-sm-8">
  <h5 class="card-body h6">CCN CHECKER</h5>
  <div class="card-body">
    <center><span>[MADE BY MAARI]</span></center>
<div class="md-form">
	<div class="col-md-12">
  <textarea type="text" style="text-align: center;"  id="lista" maxlength="2800" class="md-textarea form-control" rows="2"></textarea>
...
<footer >
    ...
    <div class="footer-copyright text-center py-3">
      <a href="https://t.me/AbbeySaale"> CLICK HERE TO CONTACT US</a>
    </div>
